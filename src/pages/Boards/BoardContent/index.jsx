    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          minWidth: '300px',
          maxWidth: '300px',
          bgcolor: (theme) => (theme.palette.mode === 'dark' ? '#333463' : '#ebecf0'),
          ml: 2,
          borderRadius: '6px',
          height: 'fit-content',
          ...
          <Box sx={{
            ...
            <Card sx={{ curosr: 'pointer', boxShadow: '0 1px 1px rgba(0,0,0,0.2)', overflow: 'unset' }}>
              <CardMedia
                sx={{ height: 140 }}
